...
//  @Embedded: Marks the PaymentInformation class as embeddable (not an entity by itself). Instead of being a separate entity that has its own table, this embedded object’s attributes will be stored directly in the User table
